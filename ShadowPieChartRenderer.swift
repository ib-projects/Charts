...
open class ShadowPieChartRenderer: DataRenderer
{
    @objc open weak var chart: ShadowPieChartView?

    @objc public init(chart: ShadowPieChartView, animator: Animator, viewPortHandler: ViewPortHandler)
    {
    ...
    @objc open func drawDataSet(context: CGContext, dataSet: IPieChartDataSet)
    {
        ...
        if let offset = chart.shadowOffset,
            let blur = chart.shadowBlur,
            let color = chart.shadowColor {
