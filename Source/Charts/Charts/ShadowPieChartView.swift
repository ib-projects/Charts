...
open class ShadowPieChartView: PieRadarChartViewBase
{
    ...
    internal override func initialize()
    {
        ...
        renderer = ShadowPieChartRenderer(chart: self, animator: _animator, viewPortHandler: _viewPortHandler)
        _xAxis = nil
